...
password = tk.Label(master=frame, text="Password will show here.",
                    name="password", font=font, wraplength=500, justify="center")
button = tk.Button(master=frame, text="Generate Password",
                   command=gen, font=font)
copyButton = tk.Button(master=frame, text="Copy Password",
                       name="copy_password", command=copy, font=font)
